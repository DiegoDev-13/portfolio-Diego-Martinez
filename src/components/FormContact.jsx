                    ...
                    : <>
                        <div className="flex justify-between space-x-5">
                            <div className="w-full flex flex-col space-y-3 transition-all duration-300">
                                <label htmlFor="from_nam" className="text-xs text-stone-400 uppercase">identity</label>
                        ...
                        <div className="w-full my-6 flex flex-col space-y-3">
                            <label htmlFor="message" className="text-xs text-stone-400 uppercase">message</label>
                            <textarea name="message" id="message" required className="w-full max-h-80 bg-stone-900 p-3 rounded-lg text-stone-200" rows="7" cols="10" maxLength={600} placeholder="Briefly describe your vision...">
