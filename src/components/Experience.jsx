...
export const Experience = () => {
  ...
  return (
    <div id={texts.navbar.navLinks[1]} className="w-full flex flex-col justify-center p-10">
        <div>
        ...
        <div className="flex justify-center items-center gap-3 mb-8 bg-stone-950/70 border border-stone-800 p-4 rounded-lg">
            <h3 className="text-stone-200 text-2xl font-medium">{texts.experience.subTitle}</h3>
        </div>
